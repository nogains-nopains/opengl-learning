...
int main( void )
{
	...
	// must call this function before set the bufferdata,
	// otherwise, no data is going to display.
   ...
   static const GLfloat g_vertex_buffer_triangle[] = { 
	...
	static const GLushort g_element_buffer_triangle[] = { 0, 1, 2 };
	GLuint vertexbuffertriangle;
	glGenBuffers(1, &vertexbuffertriangle);
	glBindBuffer(GL_ARRAY_BUFFER, vertexbuffertriangle);
	glBufferData(GL_ARRAY_BUFFER, sizeof(g_vertex_buffer_triangle), g_vertex_buffer_triangle, GL_STATIC_DRAW);
	...
	glBufferData(GL_ARRAY_BUFFER, sizeof(g_color_buffer_data), g_color_buffer_data, GL_STATIC_DRAW);
		...
		glBindBuffer(GL_ARRAY_BUFFER, vertexbuffer); //bind the vertexbuffer to the pipeline buffer.
	// must call glBindBuffer before call the glVertexAttribPointer,
	// otherwise, the graphic is displayed like pieces of triangles.
